...
while [ $r -lt 2 ]; do
	...
	while [ ${m} -lt 2 ]; do
	    ...
	    python create_control_program.py ${r} ${genetree}
	    echo " control program created "
	    cp /projects/tallis/kbanerj3/dactal/scripts/mpest/my_control.usertree /projects/tallis/kbanerj3/tools/mpest_1.5/src/my_control.usertree
	    echo "  copying my_control.usertree "
	    cp ${genetree} /projects/tallis/kbanerj3/tools/mpest_1.5/src/gene_tree_${r}
	    echo "  copying  gene tree "
